...
class Post(models.Model):
    ...
    markup          = models.CharField(_(u"Post Content Markup"), default='markdown', max_length=50)
    ...
    animation_updated_at = models.DateTimeField(_('animation updated at'), default=datetime.now)
