...
class PhotoUploadForm(forms.ModelForm):
    ...
    class Meta:
        model = Image
        exclude = ('member', 'photoset', 'effect', 'crop_from', 'owner_type', 'owner_id', 'animation', 'flag', 'animation_updated_at')
...
class PhotoEditForm(forms.ModelForm):
    ...
    class Meta:
        model = Image
        exclude = ('member', 'photoset', 'title_slug', 'effect', 'crop_from', 'image','owner_type')
